...
public static class LuaBinding
{
    ...
    public static void Binding()
    {
        ...
        ////此处添加自动拷贝到persistentDataPath
        //var persistentPath = Application.persistentDataPath + "/lua";
        //if (!Directory.Exists(persistentPath))
        //{
        //    FileUtil.CopyFileOrDirectory(uluaPath, persistentPath);
        //} else
        //{
        //    FileUtil.ReplaceFile(uluaPath + "/system/wrap.lua", persistentPath + "/System/Wrap.lua");
        //}
